# Monolith 0.9.7d: Advanced Spatial Analysis Dashboard
...
├── monolith_ver_0.9.7d.R            # Main Application Runner (Sources global.R)
├── spatial_helpers_0.9.7d.R         # Spatial math, interpolation methods & CV logic
├── ui_helpers_0.9.7d.R              # Analytics, descriptive plots & fuzzy matching helpers
├── theme_helpers_0.9.7d.R           # Theming & export configurations
├── gov_module_0.9.7d.R              # Governing Factors UI & Server Modules
├── desc_exploratory_module_0.9.7d.R # Descriptive & Exploratory Suite (Tab 5 Module)
│
