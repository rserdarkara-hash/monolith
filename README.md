...
# Monolith Spatial Analysis Dashboard (v1.0.8a)

[![Version](https://img.shields.io/badge/version-1.0.8a-6f42c1)](#)
...
<details>
<summary><strong>Tested version matrix</strong>: the exact package versions Monolith 1.0.8a is developed and validated against (click to expand)</summary>
