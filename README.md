# Monolith 0.9.8b: Advanced Spatial Analysis Dashboard
...
> [!IMPORTANT]
> **Automated Package Setup in v0.9.8b:**
> You **do not need** to execute any manual `install.packages(...)` console commands.
> Sourcing the dashboard or launching `monolith_ver_0.9.8b.R` automatically triggers a smart **Auto-Installation Hook** inside `global_0.9.8b.R`. This hook scans your environment, identifies any missing packages from the required suite, and downloads them non-interactively from the cloud CRAN repository.
> 
...
├── theme_helpers_0.9.8b.R           # Theming & export configurations
├── gov_module_0.9.8b.R              # Governing Factors UI & Server Modules
├── desc_exploratory_module_0.9.8b.R # Descriptive & Exploratory Suite (Tab 5 Module)
│
...
1. Open the `monolith_ver_0.9.8b.R` file in RStudio.
