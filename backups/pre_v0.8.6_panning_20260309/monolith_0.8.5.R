...
# --- Improvements---
source("improvements/ui_helpers_0.8.5.R")
source("improvements/spatial_helpers_0.8.5.R")
source("improvements/theme_helpers_0.8.5.R")
...
ui <- fluidPage(
  ...
  div(class = "header-panel", style = "display: flex; justify-content: space-between; align-items: center; padding: 5px 20px;",
      h1(class = "header-title", "Monolith Spatial Analysis Dashboard (ver. 0.8.5)", style = "white-space: nowrap; margin: 0;"),
