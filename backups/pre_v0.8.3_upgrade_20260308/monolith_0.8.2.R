...
# --- Improvements (v1.5a) ---
source("improvements/ui_helpers_0.8.2.R")
source("improvements/spatial_helpers_0.8.2.R")
source("improvements/theme_helpers_0.8.2.R")
                ...
                tabPanel("2. Map Viewer",
                         div(style="margin-bottom:10px; display: flex; align-items: center; gap: 10px; flex-wrap: wrap; background-color: #f8f9fa; padding: 10px; border-radius: 5px; border: 1px solid #ddd;",
                             ...
                             div(style="display: flex; align-items: center; gap: 5px;",
                                 tags$span("Base Map:", style="font-weight: bold; font-size: 0.9em;"),
                             ...
                             actionButton("show_popup_settings", "Pop-up Settings", icon = icon("cog"), class = "btn-info btn-sm", style = "margin-left: auto;"),
