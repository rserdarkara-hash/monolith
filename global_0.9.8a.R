# global_0.9.8a.R - Centralized Configuration & Dependencies for Monolith v0.9.8a
...
# --- Source v0.9.8a Helper Modules ---
source("ui_helpers_0.9.8a.R")
source("spatial_helpers_0.9.8a.R")
source("theme_helpers_0.9.8a.R")
source("gov_module_0.9.8a.R")
source("desc_exploratory_module_0.9.8a.R")
