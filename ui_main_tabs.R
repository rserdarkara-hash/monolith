                 ...
                 div(style = "padding: 8px 2px;",
                     ...
                     conditionalPanel(condition = "output.file_uploaded",
                        div(class = "setup-card",
                            ...
                            div(class = "setup-grid",
                                selectizeInput("map_crs", "Input Data CRS", choices = crs_choice_groups(common_crs_input), selected = "",
                                               options = list(create = TRUE,
                                                              placeholder = "Select the CRS your coordinates were recorded in",
                                                              onInitialize = I('function() { this.setValue(""); }'))),
                                selectizeInput("crs_selection", "Target Mapping CRS", choices = crs_choice_groups(common_crs_target), selected = "",
                                               options = list(create = TRUE,
